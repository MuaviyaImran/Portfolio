...
export default function Footer() {
  return (
    <section className="lg:flex lg:justify-evenly py-5 px-5">
      <div className="flex items-center hover:animate-pulse animate__animated animate__bounce cursor-pointer py-2">
      ...
      <div className="flex items-center hover:animate-pulse animate__animated animate__bounce py-2">
